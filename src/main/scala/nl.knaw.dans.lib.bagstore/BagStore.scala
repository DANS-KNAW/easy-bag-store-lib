...
class BagStore(val baseDir: File,
               ...
               val containerDirPermissions: Set[PosixFilePermission] = PosixFilePermissions.fromString("rwxrwx---").asScala.toSet) extends DebugEnhancedLogging {
  /**
  ...
  def isVirtuallyValid(bag: File): Try[Unit] = {
    // TODO: Implement isVirtuallyValid
    Success(())
  }
